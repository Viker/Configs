...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     ;; version-control
     ;;
     ;;OTHER LANGUAGES AND AUTOCOMPLETIONS
     csharp
     )
